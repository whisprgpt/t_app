...
export default function AppConfigCard({
    ...
    const isMac = window.electron.isMac() === "darwin";
    ...
    const handleDeleteCache = async () => {
        try {
            const result = await window.electron.deleteCache();
            ...
            <CardContent className="space-y-6 relative z-10">
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3 max-w-md">
                        ...
                        <div className="text-emerald-200 font-bold text-xl px-2">
                            ×
                        </div>
                        <div className="flex-1 relative">
                            <input
                ...
                <div className="space-y-3">
                    ...
                    <div className="p-4 bg-gradient-to-r from-slate-800/40 to-emerald-900/20 rounded-2xl border border-emerald-500/20">
                        ...
                        <p className="text-sm text-slate-300 leading-relaxed mt-2">
                            Adjust window transparency. Minimum is 0.05 to avoid full invisibility.
                        </p>
                    </div>
                    <Dialog open={focusDialog} onOpenChange={setFocusDialog}>
                        <ResponsiveDialog
                            ...
                            description={
                                <>
                                    Turning <strong>Focus off</strong> removes keyboard focus from WhisprGPT.
                                    You will <strong>NOT</strong> be able to type inside of WhisprGPT.
                                    Make sure you’re signed into your LLM provider(s) beforehand.
                                    <br /><br />
                ...
                <div className="space-y-3">
                    ...
                    <div className="p-4 bg-gradient-to-r from-slate-800/40 to-emerald-900/20 rounded-2xl border border-emerald-500/20">
                        <div className="flex items-center justify-between">
                            ...
                            <div
                                className={`px-3 py-1 rounded-2xl text-xs font-bold border-2 ${settings.focusable
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-amber-300 text-sm font-medium">
                                    This will reset your macOS permissions for Microphone and Screen Capture. Execute this when having trouble with permissions.
                                </p>
                            </div>
                            <Dialog open={resetDialog} onOpenChange={setResetDialog}>
                                ...
                                <ResponsiveDialog
                                    ...
                                    description={
                                        <>
                                            Inside <i>Screen Capture</i> page you will still see <i>wTerm</i> inside of
                                            <i> System Audio Recording Only</i>, remove it and re-add it. Add <i>wTerm</i> to <i>Screen & System Audio Recording</i> as well.
                                        </>
                                    }
                                    footer={
                                        <Button
                                            onClick={async () => {
                                                ...
                                                window.permissions.resetPermissions();
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-red-300 text-sm font-medium">
                                    This will permanently delete all cached data and
                                    sign you out of all accounts.
                                </p>
                            </div>
